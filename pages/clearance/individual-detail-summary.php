      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <p class="card-title"><h4 id="title-name">Department Clearance Detail</h4></p>
                        <hr id="title-hr">
            ...
            <div class="row">
                ...
                <form action="" method="post">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button onclick="closeTab()" class="btn btn-info btn-sm">Close Tab</button>
                       <?php 
                    //    echo '<a href="clearance-item-summary.php?id='.base64_encode($cl_id).'&cf=cf" class="btn btn-info btn-sm">Back</a>'; 
                       ?>
                    </div>
