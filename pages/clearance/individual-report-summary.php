...
<?php
        ...
        if (isset($_GET['id'])) {
            if (!empty($_GET['id'])) {
              ...
              WHERE cl_requests.cl_req_id = '$cl_id' AND cl_requests_steps.step>0 AND cl_requests_steps.is_complete=1 AND cl_requests_steps.bd_code = '$dept' AND cl_requests.status = 1 ";
              //echo $query;exit;
                ...
                if ($clearance->num_rows != 1) {
                    ...
                    echo "<script>window.location.href = 'individual-report.php';</script>";
                    exit;
                }   
                                ...
                                <div class="media-body">
                                    <table width="100%" class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $clearance['selected_branch'] ?></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        <tr>
            ...
            <div class="row">
                ...
                <div>
                    ...
                    echo '<div class="card mt-2"><div class="card-body"><div class="row">
                            ...
                            <div class="col-sm-9">
                            <form action="../../back/clearance-allocated-action-manage.php" id="customerVisitReportForm" method="POST" enctype="multipart/form-data">
                                <input type="file" class="form-control mb-2" id="customervisitreport" name="customervisitreport" accept=".pdf, .jpg, .jpeg, .png" required>';
                            echo '<button type="submit" class="btn btn-primary btn-sm mt-2 mb-2" name="customerVisitReportForm" id="customerVisitReportForm">Upload</button>';
                    ...
                    function generateTable($conn, $d_code, $cl_step_id) {
                        ...
                        if ($items->num_rows > 0) {
                            ...
                            echo "</div>";
                            echo "<div id='MonetaryCard' class='collapse show'>";
                    ...
                    function generatePhysicalTable($conn, $d_code, $cl_step_id) {
                        ...
                        if ($items->num_rows > 0) {
                            ...
                            echo "</div>";
                            echo "<div id='IssueCard' class='collapse show'>";
                            echo "<div class='card-body'>";
                            echo "<table class='table table-bordered'>";
                            echo "<thead><tr>
                                    <th>#</th>
