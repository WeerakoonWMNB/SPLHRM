...
<?php
        ...
        if (isset($_GET['id'])) {
            if (!empty($_GET['id'])) {
              ...
              WHERE cl_requests.cl_req_id = '$cl_id' AND cl_requests_steps.step>1 AND cl_requests_steps.is_complete=1 AND cl_requests_steps.bd_code = '$dept' AND cl_requests.status = 1 ";
              //echo $query;exit;
