                            ...
                            <td align="left">
                              <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                <tbody>
                                  ...
                                  <tr><td><strong>Employee ID/Sales Code:</strong> '.$row['epf_no'].'/'.$row['code'].'</td></tr>
...
function clearanceRequestPending($cl_id,$pending_note) {
    ...
    if ($_SERVER['HTTP_HOST'] === 'hrinfo.sadaharitha.com'){
      ...
      if ($branch_code == 'admin') {
        $mailid[] = 'sanjeewa@sadaharitha.com';
      }
    }
    $mailid[] = 'nishshankaw@sadaharitha.com';
...
function croMail($mCode,$mname,$uname,$pass,$branchmail) {
  ...
  sendMail($mailid, $mailheading, $content, 'HRM System (Online Proposal Login)');
}

// Get input parameters
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['param1'])) {
  $mCode = $_POST['param1'];
  $mname = $_POST['param2'];
  $uname = $_POST['param3'];
  $pass = $_POST['param4'];
...
//clearance request accept email notify to heads
function clearanceRequestAcceptNotify($cl_id) {
              ...
              <div class="content">
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main" style="background: #ffffff; border: 1px solid #eaebed; border-radius: 16px; width: 100%;">
                  ...
                  <tr>
                    <td class="wrapper" style="padding: 24px;">
                      <p>Dear Team,</p>
                      <p>Please be informed that the following <b>employee has resigned from the organization</b>. Kindly take the necessary immediate actions to deactivate or block any system access, accounts, and other privileges granted to the employee, and complete any relevant departmental procedures.</p>
                      ...
                      <p><strong>Next Steps:</strong></p>
                      <ul>
                        <li><strong>All Department:</strong> Kindly deactivate and block all system access and accounts associated with this employee with immediate effect, and prepare for the clearance process.</li>
                      </ul>
    ...
    // SQL query to find exact matches in bd_id column
    // $sql = "SELECT u.username FROM resign_mail_receivers_list rl
    ...
    // }
    $mailid[] = 'nishshankaw@sadaharitha.com';
    $mailheading = 'Employee Resigned. Immediate Necessary Actions Required (#'.$row['cl_req_id'].')';
